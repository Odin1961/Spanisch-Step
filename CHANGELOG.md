...
- schwierige und fällige Wörter werden priorisiert
- unmittelbare Wiederholungen verhindert
- Lernstatistik ergänzt
- doppelte Bewertung verhindert

## 1.2
- Sprachwarteschlange neu aufgebaut
- lange spanische Texte werden in sichere Abschnitte geteilt
- vollständige Wiedergabe vor dem nächsten Dialogschritt
- mobile Resume-Überwachung ergänzt
- Stimmenauswahl für Spanien und Lateinamerika verbessert

## 1.1
- Gesprächsengine neu aufgebaut
- fortlaufende Gespräche bis zum manuellen Beenden
- automatischer Szenenwechsel
- Wiederholungsschutz für Szenarien
- einheitlicher Ablauf für freie und verzweigte Gespräche

## 1.0

- 250 weitere spanische Vokabeln und Wendungen
- 25 weitere verzweigte Gespräche
- 25 weitere Gespräche mit freien Antworten
- 80 weitere Grammatikaufgaben
- insgesamt 2.500 Vokabeln, 500 Gespräche und 800 Grammatikaufgaben
- erste vollständige Hauptversion

# Changelog

## 0.2

- 250 weitere spanische Vokabeln
- 25 weitere verzweigte Gespräche
- 25 weitere Gespräche mit freien Antworten
- 80 weitere Grammatikaufgaben A1–B2
- insgesamt 500 Vokabeln, 100 Gespräche und 160 Grammatikaufgaben

## 0.1

- technische Basis aus dem stabilen English-Step-Aufbau übernommen
- 250 spanische Vokabeln
- 50 Gesprächssituationen
- 80 Grammatikaufgaben A1–B2
